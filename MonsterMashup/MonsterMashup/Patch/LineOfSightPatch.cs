...
namespace MonsterMashup.Patch
{
    ...
    public static class LineOfSight_GetLineOfFireUncached
    {
        ...
        static void Prefix(ref bool __runOriginal, ref LineOfFireLevel __result, LineOfSight __instance, AbstractActor source,
            Vector3 sourcePosition, ICombatant target, Vector3 targetPosition, Quaternion targetRotation, ref Vector3 collisionWorldPos)
        {
        ...
        static void Postfix(ref bool __runOriginal, ref LineOfFireLevel __result, LineOfSight __instance, AbstractActor source,
            Vector3 sourcePosition, ICombatant target, Vector3 targetPosition, Quaternion targetRotation, ref Vector3 collisionWorldPos)
        {
                IgnoredActors.Clear();               
        }
